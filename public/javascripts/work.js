...
namespace('sample.video', function(exports) {
...
namespace('sample.face', function(exports) {
  var draw, image, _comp, _drawInterval, _image, _isDraw;
  image = new Image();
  ...
  return exports.changePict = function(pict) {
